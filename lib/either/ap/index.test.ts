...
test("[ap] (either) supports identity", () => {
	fc.assert(
...
test("[ap] (either) is homomorphic - lift then combine, or combine and then lift", () => {
...
test("[ap] (either) supports interchange - applies rhs to lhs with no special handling", () => {
